...
plot((atan2(-bothTogether$airmar_fb_fixed,-bothTogether$airmar_ss_fixed)*(180/pi)+360)%%360,
     (bothTogether$airmar_wd_fixed*(180/pi)+360)%%360)

plot(bothTogether$windmaster_wd_fixed)
points(bothTogether$airmar_wd_fixed,col='red')

plot(bothTogether$sideSideWindmaster_fixed)
points(bothTogether$airmar_ss_fixed,col='red')

plot(bothTogether$frontBackWindmaster)
points(bothTogether$airmar_fb_fixed,col='red')
...
plot(y=parkedDat$airmar_ss_fixed,x=parkedDat$sideSideWindmaster_fixed,
      xlab='Side-side, windmaster',ylab='side-side,airmar',
...
```{r}
fit2_fb <- lm(bothTogether$frontBackWindmaster~bothTogether$airmar_fb_fixed+bothTogether$Velocity)

fit2_fb <- lm(bothTogether$frontBackWindmaster~bothTogether$airmar_fb_fixed)

fit3_fb <- lm(bothTogether$frontBackWindmaster~bothTogether$airmar_fb_fixed + bothTogether$Velocity + bothTogether$airmar_fb_fixed * bothTogether$Velocity)

fit3_fb <- lm(bothTogether$frontBackWindmaster~bothTogether$airmar_fb_fixed)


fit2_side <- lm(bothTogether$sideSideWindmaster_fixed~bothTogether$airmar_ss_fixed+bothTogether$Velocity)

fit2_side <- lm(bothTogether$sideSideWindmaster_fixed~bothTogether$airmar_ss_fixed)
...
$$ \text{WS}_{W,fb} = 0.248 + \left(0.832 *\text{WS}_{A,fb}\right)$$
